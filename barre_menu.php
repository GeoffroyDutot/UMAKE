...
<div id="menu">
   ...
   <ul>
     ...
     <li><a href="Cours\Digital\presentation_dev.php">DEV ▼</a>
      ...
      <li><a href="Cours\Digital\presentation_digi.php">DIGI ▼</a>
        <ul>
          <li><a href="#">Listes des cours </a></li>
          <li><a href="#">Derniers cours</a></li>
          <li><a href="#">Cours populaire</a></li>
        </ul>
      <li><a href="Cours\Digital\presentation_ops.php">OPS ▼</a>
        <ul>
          <li><a href="#">Listes des cours</a></li>
          <li><a href="#">Derniers cours</a></li>
          <li><a href="#">Cours populaire</a></li>
